...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=CECSCIMP;Database=POS;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF983D8B7BB");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E3E602857");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0BB35F6CE7");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24D487B02A");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED69D6E8B6");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C634E43F9E");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E19E7ECA81");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED230721DD260");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0CA978CBC2");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD7BFAB80C");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D3DBB7D37");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F83250C0F04");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674BBE55EB22");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248BE47EE4A5");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1AEECF030A");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FF7ACA11DD");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE26EEEB02");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C22121979");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A3528303B54");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A6C7D68C0");
